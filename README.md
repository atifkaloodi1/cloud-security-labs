...
| 05 | [Build Your DB Server and Interact With Your DB Using an App](lab-05-rds-multi-az/) | Managed RDS (MySQL), Multi-AZ high availability, DB subnet groups, security-group chaining, app-to-DB connectivity | ✅ Complete |
